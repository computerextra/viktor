...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			abteilung.Table:       abteilung.ValidColumn,
			angebot.Table:         angebot.ValidColumn,
			ansprechpartner.Table: ansprechpartner.ValidColumn,
			aussteller.Table:      aussteller.ValidColumn,
			einkauf.Table:         einkauf.ValidColumn,
			...
			statu.Table:           statu.ValidColumn,
			warenlieferung.Table:  warenlieferung.ValidColumn,
		})
	})
