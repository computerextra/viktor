...
func (ju *JobUpdate) SetOnline(b bool) *JobUpdate {
	ju.mutation.SetOnline(b)
	return ju
}

// SetNillableOnline sets the "online" field if the given value is not nil.
func (ju *JobUpdate) SetNillableOnline(b *bool) *JobUpdate {
	if b != nil {
		ju.SetOnline(*b)
	}
	return ju
...
func (ju *JobUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ju.mutation.Online(); ok {
...
// SetOnline sets the "online" field.
func (juo *JobUpdateOne) SetOnline(b bool) *JobUpdateOne {
	juo.mutation.SetOnline(b)
	return juo
}

// SetNillableOnline sets the "online" field if the given value is not nil.
func (juo *JobUpdateOne) SetNillableOnline(b *bool) *JobUpdateOne {
	if b != nil {
		juo.SetOnline(*b)
	}
	return juo
...
func (juo *JobUpdateOne) sqlSave(ctx context.Context) (_node *Job, err error) {
	...
	if value, ok := juo.mutation.Online(); ok {
		_spec.SetField(job.FieldOnline, field.TypeBool, value)
	}
