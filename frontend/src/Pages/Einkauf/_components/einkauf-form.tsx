...
import { UploadImage } from "@bindings/viktor/backend/app";
...
export default function EinkaufForm({
  ...
  const handleSubmit = async (values: z.infer<typeof formSchema>) => {
    setLoading(true);
    await MitarbeiterAPI.UpdateEinkauf(mitarbeiter.Id, {
      ...
      <div className="grid grid-cols-2 gap-4 mt-5">
        <Button
          ...
          onClick={async (e) => {
            e.preventDefault();
            setLoading(true);
            await MitarbeiterAPI.EinkaufSkip(mitarbeiter.Id);
            await navigate("/");
            setLoading(false);
          }}
        >
        ...
        <Button
          ...
          onClick={async (e) => {
            e.preventDefault();
            setLoading(true);
            await MitarbeiterAPI.EinkaufDelete(mitarbeiter.Id);
            await navigate("/");
            setLoading(false);
          }}
        >
